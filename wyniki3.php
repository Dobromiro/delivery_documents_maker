...
<header class="w3-center w3-margin-bottom">
  ...
  <p><b></b></p>
  <p><b></b></p>
  <h2>BOX SCANNING HISTORY - RAW DATA</h2>
  <h3> PSM </h3>
  <p><b></b></p>
...
$i = 1;
$DATE = date("Y-m-d");
$sql = "SELECT * FROM main WHERE DATE = '$wyrazenie' ";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
			...
			echo "<td>".$row["MODULES-QTY"]."</td>";
			echo "<td>".$row["BOX-SN"]."</td>";
			echo "<td>".$row["DATE"]."</td>";	
			echo "<td>".$row["INCOMING_TIME"]."</td>";	
			echo "<td>".$row["OUTCOMING-DATE"]."</td>";

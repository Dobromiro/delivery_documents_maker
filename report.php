...
$i = 1;
$DATE = date("Y-m-d");
$TOTAL = "SELECT MODEL, COUNT(*) AS 'BOXQTY' FROM collect ";
$sql = "SELECT MODEL, SUM(`MODULES-QTY`) AS 'MODULES', COUNT(*) AS 'BOXQTY' FROM collect GROUP BY MODEL"; // pamietaj main - > collect

$sql2 = "SELECT MODEL, COUNT(*) AS 'BOXQTY' FROM collect GROUP BY MODEL ";
...
?>
		...
		<p align="center">
			...
			<table>
			<tr>
			<td><a href="mechanism.php">GENERATE DELIVERY DOC</a> </td>
			<td><a href="fpdf/report-pdf.php" target="_blank">LAST DELIVERY DOC</a> </td>

...
<form action="wyniki3.php" method="post">
...
?>
      ...
      Search like date (for e.g. : 2020-01-01):
	  <table>
	  <td>
	  <input style="display: inline;" type="text" name="DATE" autofocus/>
	  </td>
	  </tr>
	  </table>
	  
      <input type="submit" style="display: inline; padding:5px" name="wyszukaj" />
    </form>
		</div>
